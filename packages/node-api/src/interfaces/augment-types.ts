...
import type { Ballot, BallotStatus, Beneficiary, CollectionItem, CollectionItemFile, CollectionItemId, CollectionItemToken, CollectionSize, File, FileParams, HostData, LegalOfficerCaseOf, LegalOfficerCaseSummary, LegalOfficerData, LoAuthorityListStorageVersion, LocId, LocLink, LocLinkParams, LocType, LocVoidInfo, LogionVote, MetadataItem, MetadataItemParams, OtherAccountId, Region, Requester, Sponsorship, SponsorshipId, StorageVersion, SupportedAccountId, TermsAndConditionsElement, TokenIssuance, TokensRecord, TokensRecordFile, VerifiedIssuer, VoteApproved, VoteClosed, VoteId } from '@logion/node-api/dist/interfaces/default';
