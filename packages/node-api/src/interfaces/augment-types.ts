...
import type { Ballot, BallotStatus, Beneficiary, CollectionItem, CollectionItemFile, CollectionItemId, CollectionItemToken, CollectionSize, File, FileParams, HostData, LegalOfficerCaseOf, LegalOfficerCaseSummary, LegalOfficerData, LoAuthorityListStorageVersion, LocId, LocLink, LocType, LocVoidInfo, LogionVote, MetadataItem, MetadataItemParams, OtherAccountId, Region, Requester, Sponsorship, SponsorshipId, StorageVersion, SupportedAccountId, TermsAndConditionsElement, TokenIssuance, TokensRecord, TokensRecordFile, UnboundedTokensRecordFile, UnboundedTokensRecordFileOf, VerifiedIssuer, VoteApproved, VoteClosed, VoteId } from '@logion/node-api/dist/interfaces/default';
...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    UnboundedTokensRecordFile: UnboundedTokensRecordFile;
    UnboundedTokensRecordFileOf: UnboundedTokensRecordFileOf;
