...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletLogionLocStorageVersion (194) */
  ...
  /** @name PalletVerifiedRecoveryError (196) */
  ...
  /** @name PalletLogionVaultError (197) */
  ...
  /** @name LogionNodeRuntimeRuntime (213) */
