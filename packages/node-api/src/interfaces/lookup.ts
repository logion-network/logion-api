...
export default {
  ...
  /**
   * Lookup160: pallet_logion_vote::pallet::Call<T>
   **/
  ...
  /**
   * Lookup163: pallet_node_authorization::pallet::Error<T>
   **/
  ...
  /**
   * Lookup168: pallet_recovery::RecoveryConfig<BlockNumber, Balance, sp_core::bounded::bounded_vec::BoundedVec<sp_core::crypto::AccountId32, S>>
   **/
  ...
  /**
   * Lookup171: pallet_recovery::ActiveRecovery<BlockNumber, Balance, sp_core::bounded::bounded_vec::BoundedVec<sp_core::crypto::AccountId32, S>>
   **/
  ...
  /**
   * Lookup172: pallet_recovery::pallet::Error<T>
   **/
  PalletRecoveryError: {
  ...
  /**
   * Lookup173: pallet_assets::types::AssetDetails<Balance, sp_core::crypto::AccountId32, DepositBalance>
   **/
  ...
  /**
   * Lookup174: pallet_assets::types::AssetStatus
   **/
  PalletAssetsAssetStatus: {
    _enum: ['Live', 'Frozen', 'Destroying']
  },
  /**
   * Lookup176: pallet_assets::types::AssetAccount<Balance, DepositBalance, Extra>
   **/
  ...
  /**
   * Lookup177: pallet_assets::types::ExistenceReason<Balance>
   **/
  ...
  /**
   * Lookup179: pallet_assets::types::Approval<Balance, DepositBalance>
   **/
  ...
  /**
   * Lookup180: pallet_assets::types::AssetMetadata<DepositBalance, sp_core::bounded::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup182: pallet_assets::pallet::Error<T, I>
   **/
  PalletAssetsError: {
  ...
  /**
   * Lookup183: pallet_lo_authority_list::pallet::StorageVersion
   **/
  PalletLoAuthorityListStorageVersion: {
    _enum: ['V1', 'V2AddOnchainSettings', 'V3GuestLegalOfficers']
  },
  /**
   * Lookup184: pallet_lo_authority_list::pallet::Error<T>
   **/
  ...
  /**
   * Lookup185: pallet_logion_loc::LegalOfficerCase<sp_core::crypto::AccountId32, primitive_types::H256, LocId, BlockNumber>
   **/
  ...
  /**
   * Lookup186: pallet_logion_loc::Requester<sp_core::crypto::AccountId32, LocId>
   **/
  ...
  /**
   * Lookup189: pallet_logion_loc::LocType
   **/
  PalletLogionLocLocType: {
    _enum: ['Transaction', 'Identity', 'Collection']
  },
  /**
   * Lookup192: pallet_logion_loc::LocVoidInfo<LocId>
   **/
  PalletLogionLocLocVoidInfo: {
    replacer: 'Option<u128>'
  },
  /**
   * Lookup197: pallet_logion_loc::CollectionItem<primitive_types::H256, LocId>
   **/
  ...
  /**
   * Lookup198: pallet_logion_loc::pallet::StorageVersion
   **/
  ...
  /**
   * Lookup199: pallet_logion_loc::pallet::Error<T>
   **/
  ...
  /**
   * Lookup200: pallet_verified_recovery::pallet::Error<T>
   **/
  PalletVerifiedRecoveryError: {
    _enum: ['InvalidLegalOfficers', 'MissingIdentityLoc']
  },
  /**
   * Lookup201: pallet_logion_vault::pallet::Error<T>
   **/
  PalletLogionVaultError: {
    _enum: ['InvalidSignatories', 'WrongInitiator']
  },
  /**
   * Lookup202: pallet_logion_vote::Vote<LocId, sp_core::crypto::AccountId32>
   **/
