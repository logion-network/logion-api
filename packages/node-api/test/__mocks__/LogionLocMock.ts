...
import { mockValidAccountId } from "../__mocks__/PolkadotApiMock.js"
...
export const CLOSED_IDENTITY_LOC: LegalOfficerCase = {
    ...
    requesterAddress: mockValidAccountId(TEST_WALLET_USER),
    locType: 'Identity',
    closed: true,
    files: [
        {
            ...
            nature: "some-nature",
            submitter: mockValidAccountId(TEST_WALLET_USER),
            size: BigInt(128000),
        }
    ],
    metadata: [],
